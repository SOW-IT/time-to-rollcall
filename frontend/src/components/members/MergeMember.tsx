    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <div className="fixed inset-0 flex justify-center">
          ...
          >
            <DialogPanel className=" round-lg bg-white shadow-xl flex flex-col w-full h-full">
              <div
              ...
              {!showConflicts ? (
                <div className="overflow-auto h-full pb-14 px-4">
                  <div className="mt-4 px-12">
                    ...
                    <p className="mt-2 text-sm text-gray-500 text-center">
                      ...
                      primary member, and the selected member will be deleted.
                    </p>
                  </div>
                    ...
                    >
                      <div className="relative">
                        ...
                        <Transition
                          ...
                          leaveTo="opacity-0"
                        >
                          <ListboxOptions className="rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            {members.map((member) => (
                              <ListboxOption
                                key={member.id}
                                value={member}
